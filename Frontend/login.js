...
async function loginFunction() {
    try {
        ...
        const response = await fetch('http://'+urlActual+':8082/api/auth/login', {
            method: 'POST',
            headers: {
                "Content-Type": "application/x-www-form-urlencoded", // Define el tipo de contenido del cuerpo
            },
...
async function RegisterFunction() {
    ...
    try {
        ...
        const response = await fetch('http://'+urlActual+':8082/api/auth/register', {
            method: 'POST',
            headers: {
